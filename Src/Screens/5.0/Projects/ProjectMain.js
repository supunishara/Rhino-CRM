...
//import Actions
import {requestProjectData, resetReducer} from '../../../Redux/Actions/ProjectMain.actions';
...
//
  ...
  filterSearch(text){
    ...
    const newData = dataList.filter(function(item){
      const itemData = item.project_name.toString().toUpperCase() 
    ...
    return <View style={styles.Container}>
            ...
            <View style={styles.flatListContainer}>
              <View style={styles.flatListInnerView}>
                <Text style={[styles.contactText, textStyle]}>Projects</Text>
...
const mapStateToProps = state => {
  return {
    errors: state.ProjectMain.errors,
    data:state.ProjectMain.data,
    isLoading:state.ProjectMain.isLoading,
  };
};

const mapDispatchToProps = dispatch => {
  return {
    requestProjectData: () => dispatch(requestProjectData()),
