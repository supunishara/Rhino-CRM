...
//
import { getMultipleDropDownData, sendUpdateLeadData, getLeadData, resetReducer, getProjectData, addLeadToMap} from '../../../Redux/Actions/ViewLead.actions';
...
//
  ...
  componentWillReceiveProps(nextProps){  
    ...
    if(nextProps.multipleData && nextProps.multipleData.length > 0 && !nextProps.isLoading){
      console.log("nextProps.multipleData-----------------",nextProps.multipleData);
            ...
            return(
                <View>
                    <FloatingLabelInput 
                        ...
                        value={this.props.data.lead && this.props.data.lead != null ? this.props.data.lead[0].contact.first_name : "-"}
                        editable={editable}
