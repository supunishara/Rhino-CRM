...
//
  ...
  componentWillReceiveProps(nextProps){ 
    console.log("ViewContact nextProps===========",nextProps);
    ...
    if(nextProps.multipleData){
      ...
      if(nextProps.multipleData[1].name && nextProps.multipleData[1].name.length > 0){
        this.companyArray = [];
    ...
    if(nextProps.data.contact ){
      this.setState({
        ...
        notes: nextProps.data.contact.user_note,
        selectedTitleText: nextProps.data.contact.title,
      });

      if(nextProps.data.contact.company != null){
        this.setState({
          selectedCompanyText : nextProps.data.contact.company.business_name
        });
      }
    }
  }
...
renderBusinessDropDown(){
  ...
  if(this.props.data.contact != null){
    if(this.props.data.contact.company != null){
      return(
        <FloatingLabelInput 
          // onChangeText={(value) => this.onChangeText(value, 'email')}
          value={this.props.data.contact.company.business_name }
          editable={editable}
  ...
  renderData(){
    ...
    if(!editable){
      if(this.props.data && this.props.data != null && !this.props.isLoading){
        return(
          <View>
            <FloatingLabelInput 
                // onChangeText={(value) => this.onChangeText(value, 'email')}
            ...
            {/* <FloatingLabelInput 
            // onChangeText={(value) => this.onChangeText(value, 'email')}
            value={this.props.data.contact && this.props.data.contact != null && this.props.data.contact.company.business_name && this.props.data.contact. != null ? this.props.data.contact.company.business_name : "-"}
            editable={editable}
            keyboardType='default'
            AnimatedText="Company"
            containerStyle={styles.containerStyle}
                ...
                <View style={styles.subContainerInnerView}>
                  <View style={styles.TextContainerView}>
                    ...
                    <View style={{flex:1,justifyContent:'flex-start'}}>
                      {!editable ? <Text style={[styles.contactText, textStyle]}>View Contact</Text>: <Text style={styles.contactText}>Edit Contact</Text>}
                  ...
                  <View style={styles.DetailContainerView}>
                    ...
                    {this.props.data.isEditable && this.props.data.isEditable != null ? <FAB style={styles.fabStyle} menuStyle={ThemeStyle}  icon={editable ? Correct :Pencil} onPress={() => this.onFABPressed()}/> : null} 
                  </View>
                </View>
